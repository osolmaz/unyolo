...
Colours derive from `assets/logo.svg`: warm charcoal `#211a16` and prohibition red `#d92d20`,
with cream `#f8f2e7` behind the wordmark. The brand palette contains no blue and no green. Accents are darkened for light mode
