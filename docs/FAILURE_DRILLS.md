...
| Telegram outage, retry, duplicate callback, and cancellation | callbacks remain idempotent, progress is durable, and polling stops | `approval/notifier/telegram/telegram_test.go`, `authorization/grants/notifications_test.go` |
