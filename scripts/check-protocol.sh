...
for document in protocol/openapi/operator-v1.yaml protocol/openapi/agent-v1.yaml; do
...
git diff --exit-code -- \
  ...
  protocol/schema protocol/agent-schema plugins/openclaw/src/generated
