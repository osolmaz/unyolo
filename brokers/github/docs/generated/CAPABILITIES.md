...
| `action_run.actions_delete_workflow_run_logs` | critical | protocol | installation | run | typed CLI/MCP |
...
| `artifact.actions_delete_artifact` | critical | protocol | installation | artifact | typed CLI/MCP |
| `artifact.actions_download_artifact` | low | protocol | installation | artifact | typed CLI/MCP |
| `artifact.actions_get_artifact` | low | protocol | installation | artifact | typed CLI/MCP |
...
| `artifact.orgs_create_artifact_deployment_record` | high | protocol | installation | organization | typed CLI/MCP |
| `artifact.orgs_create_artifact_storage_record` | high | protocol | installation | organization | typed CLI/MCP |
| `artifact.orgs_list_artifact_deployment_records` | low | protocol | installation | organization | typed CLI/MCP |
| `artifact.orgs_list_artifact_storage_records` | low | protocol | installation | organization | typed CLI/MCP |
| `artifact.orgs_set_cluster_deployment_records` | high | protocol | installation | organization | typed CLI/MCP |
...
| `code_scanning.code_scanning_delete_codeql_database` | critical | protocol | installation | repo | typed CLI/MCP |
...
| `code_scanning.code_scanning_get_codeql_database` | low | protocol | installation | repo | typed CLI/MCP |
| `code_scanning.code_scanning_get_default_setup` | low | implemented | installation | repo | typed CLI/MCP |
| `code_scanning.code_scanning_get_sarif` | low | protocol | installation | repo | typed CLI/MCP |
...
| `code_scanning.code_scanning_list_codeql_databases` | low | protocol | installation | repo | typed CLI/MCP |
...
| `code_scanning.code_scanning_upload_sarif` | medium | protocol | installation | repo | typed CLI/MCP |
...
| `release.repos_delete_release_asset` | critical | protocol | installation | repo | typed CLI/MCP |
...
| `release.repos_list_release_assets` | low | protocol | installation | release | typed CLI/MCP |
...
| `release.repos_update_release_asset` | medium | protocol | installation | repo | typed CLI/MCP |
